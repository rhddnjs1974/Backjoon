        ...
        for x in range(n):
            for y in range(1,n):
                ...
                while(y-1>=0 and narray[x][y-1]==0):
                    y-=1
                if y-1>=0 and narray[x][y-1]==t and flag[x][y-1] == 0:
                    narray[x][y-1]=2*t
                    flag[x][y-1] = 1
                else:
                    narray[x][y] = t
        ...
        for x in range(n):
            for y in range(n-2,-1,-1):
                ...
                while(y+1<n and narray[x][y+1]==0):
                    y+=1
                if y+1<n and narray[x][y+1]==t and flag[x][y+1] == 0:
                    narray[x][y+1]=2*t
                    flag[x][y+1] = 1
                else:
                    narray[x][y] = t
        ...
        for y in range(n):
            for x in range(n-2,-1,-1):
                ...
                while(x+1<n and narray[x+1][y]==0):
                    x+=1
                if x+1<n and narray[x+1][y]==t and flag[x+1][y] == 0:
                    narray[x+1][y]=2*t
                    flag[x+1][y] = 1
                else:
                    narray[x][y] = t
        ...
        for y in range(n):
            for x in range(1,n):
                ...
                while(x-1>=0 and narray[x-1][y]==0):
                    x-=1
                if x-1>=0 and narray[x-1][y]==t and flag[x-1][y] == 0:
                    narray[x-1][y]=2*t
                    flag[x-1][y] = 1
                else:
                    narray[x][y] = t
